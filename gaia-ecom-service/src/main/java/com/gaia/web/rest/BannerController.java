...
public class BannerController {
	...
	public ResponseEntity<BannerEntity> getBanner(@PathVariable long id) throws GaiaException {
		return new ResponseEntity<BannerEntity>(bannerService.getBanner(id), HttpStatus.OK);
	}

	@GetMapping("banner")
	public ResponseEntity<List<BannerEntity>> getBanners(@RequestParam String bannerName) throws GaiaException {
		return new ResponseEntity<List<BannerEntity>>(bannerService.getBanners(bannerName), HttpStatus.OK);
	}
	...
	public ResponseEntity<BannerImageEntity> addBannerImage(@RequestBody BannerImageEntity bannerImage) throws GaiaException {
	...
	public ResponseEntity<ResponseVm> updateBannerImage(@RequestBody BannerImageEntity bannerImage, @PathVariable long id)
			throws GaiaException {
