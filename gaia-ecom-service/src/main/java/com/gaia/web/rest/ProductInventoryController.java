...
import com.gaia.domain.ProductInventoryEntity;
...
public class ProductInventoryController {
	...
	public ResponseEntity<ProductInventoryEntity> getProductInvetry(@PathVariable long id) throws GaiaException {
		return new ResponseEntity<ProductInventoryEntity>(productInventoryService.getProductInventory(id), HttpStatus.OK);
	}

	@GetMapping("productinventory")
	public ResponseEntity<PagedResources<Resource<ProductInventoryEntity>>> getProductInvetry(
			PagedResourcesAssembler<ProductInventoryEntity> assembler, @RequestParam(name = "id", required = false) Long id,
		...
		Page<ProductInventoryEntity> response = productInventoryService.getProductInventory(request, id, productId, pageable);
