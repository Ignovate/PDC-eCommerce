...
public class ProductInventoryService {
	...
	public ProductInventoryEntity getProductInventory(Long id) {
		return prdInvRepo.findById(id).orElse(null);
	}
	
	public Page<ProductInventoryEntity> getProductInventory(Map<String, String> map, Long id, Long productId, Pageable pageable) {
		Specification<ProductInventoryEntity> spec = new Specification<ProductInventoryEntity>() {

			@Override
			public Predicate toPredicate(Root<ProductInventoryEntity> root, CriteriaQuery<?> query,
